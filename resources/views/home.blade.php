        ...
        <div class="flex flex-col min-h-screen justify-around p-7 gap-6 xl:mt-4">
            ...
            <x-slider :slides="[
                [
                    ...
                    'title' => 'Atenas',
                    'description' => 'Un lugar lleno de historia y belleza natural, ideal para una escapada relajante.',
                ...
                [
                    ...
                    'title' => 'Tailandia',
                    'description' => 'Explora el encanto de este destino con paisajes impresionantes y cultura vibrante.',
                    'buttonUrl' => route('flights')
                ]
            ]" />
        </div>
