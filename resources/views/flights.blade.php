        ...
        <script>
            $(document).ready(function() {
                ...
                var columns = [
                    ...
                    { data: 'aircraft', name: 'aircraft', orderable: false },
                    { data: 'origin', name: 'origin', orderable: false },
                    { data: 'destination', name: 'destination', orderable: false },
                    { data: 'duration', name: 'duration', orderable: false },
                    { data: 'price', name: 'price', orderable: false },
                    { data: 'seats', name: 'seats', orderable: false },
                ...
                if (isAdmin) {
                    columns.splice(9, 0, { data: 'status', name: 'status', orderable: false });
                }
                ...
                $(document).click(function(event) {
                    if (!$(event.target).closest('#filter-button').length && !$(event.target).closest('#filter-modal').length) {
                        $('#filter-modal').addClass('hidden');
                    }
                });
            });
